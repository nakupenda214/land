            ...
            <div class="build-opts-block">
              ...
              <el-form label-position="top" :disabled="!buildForm.feedbackEnabled" class="build-opts-form">
                ...
                <el-form-item label="focusTags（可多选；留空表示各环节均参考）">
                  <el-select v-model="buildForm.feedbackFocusTags" multiple collapse-tags placeholder="ROOT_CAUSE / PLAN / MQL / PYTHON_*">
                    ...
                    <el-option label="PYTHON_GENERATE" value="PYTHON_GENERATE" />
                    <el-option label="PYTHON_EXECUTE" value="PYTHON_EXECUTE" />
                    <el-option label="PYTHON_ANALYZE" value="PYTHON_ANALYZE" />
                  </el-select>
                </el-form-item>
